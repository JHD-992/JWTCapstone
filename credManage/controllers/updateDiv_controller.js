...
exports.updateDiv = function (req, res) {
  ...
  User.findOneAndUpdate({username: req.query.username}, {orgUnit: req.query.orgUnit,  division: req.query.division}, {new: true}, function (err, doc){
    if(err) {
